...
function SignotationInput({ value, inputRef, updateVal }) {
  const hili = useRef();
  return <div className="relative">
    <div ref={hili} className="p-1 w-full pointer-events-none bg-white rounded whitespace-nowrap overflow-hidden"><Signotation sn={value || "\xA0"} /></div>
    <input
      className="p-1 w-full font-mono absolute top-0 bg-transparent rounded border border-signotatormain-600 outline-none"
      type="text"
